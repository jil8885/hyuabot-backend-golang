...
func SetupRouterV1(app *fiber.App) {
	...
	shuttleGroup.Get("/period/:start/:end", v1.GetShuttlePeriod)
	shuttleGroup.Post("/period", v1.CreateShuttlePeriod)
	shuttleGroup.Delete("/period/:start/:end", v1.DeleteShuttlePeriod)
	shuttleGroup.Get("/holiday", v1.GetShuttleHolidayList)
	shuttleGroup.Get("/holiday/:calendar/:date", v1.GetShuttleHoliday)
	shuttleGroup.Post("/holiday", v1.CreateShuttleHoliday)
	shuttleGroup.Delete("/holiday/:calendar/:date", v1.DeleteShuttleHoliday)
}
