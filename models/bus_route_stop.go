...
type (
	...
	// BusRouteStopHook is the signature for custom BusRouteStop hook methods
	BusRouteStopHook func(context.Context, boil.ContextExecutor, *BusRouteStop) error
...
var busRouteStopAfterSelectHooks []BusRouteStopHook

var busRouteStopBeforeInsertHooks []BusRouteStopHook
var busRouteStopAfterInsertHooks []BusRouteStopHook

var busRouteStopBeforeUpdateHooks []BusRouteStopHook
var busRouteStopAfterUpdateHooks []BusRouteStopHook

var busRouteStopBeforeDeleteHooks []BusRouteStopHook
var busRouteStopAfterDeleteHooks []BusRouteStopHook

var busRouteStopBeforeUpsertHooks []BusRouteStopHook
var busRouteStopAfterUpsertHooks []BusRouteStopHook

// doAfterSelectHooks executes all "after Select" hooks.
func (o *BusRouteStop) doAfterSelectHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopAfterSelectHooks {
...
func (o *BusRouteStop) doBeforeInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopBeforeInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BusRouteStop) doAfterInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopAfterInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BusRouteStop) doBeforeUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopBeforeUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BusRouteStop) doAfterUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopAfterUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BusRouteStop) doBeforeDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopBeforeDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BusRouteStop) doAfterDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopAfterDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BusRouteStop) doBeforeUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopBeforeUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BusRouteStop) doAfterUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range busRouteStopAfterUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
// AddBusRouteStopHook registers your hook function for all future operations.
func AddBusRouteStopHook(hookPoint boil.HookPoint, busRouteStopHook BusRouteStopHook) {
	switch hookPoint {
	case boil.AfterSelectHook:
		busRouteStopAfterSelectHooks = append(busRouteStopAfterSelectHooks, busRouteStopHook)
	case boil.BeforeInsertHook:
		busRouteStopBeforeInsertHooks = append(busRouteStopBeforeInsertHooks, busRouteStopHook)
	case boil.AfterInsertHook:
		busRouteStopAfterInsertHooks = append(busRouteStopAfterInsertHooks, busRouteStopHook)
	case boil.BeforeUpdateHook:
		busRouteStopBeforeUpdateHooks = append(busRouteStopBeforeUpdateHooks, busRouteStopHook)
	case boil.AfterUpdateHook:
		busRouteStopAfterUpdateHooks = append(busRouteStopAfterUpdateHooks, busRouteStopHook)
	case boil.BeforeDeleteHook:
		busRouteStopBeforeDeleteHooks = append(busRouteStopBeforeDeleteHooks, busRouteStopHook)
	case boil.AfterDeleteHook:
		busRouteStopAfterDeleteHooks = append(busRouteStopAfterDeleteHooks, busRouteStopHook)
	case boil.BeforeUpsertHook:
		busRouteStopBeforeUpsertHooks = append(busRouteStopBeforeUpsertHooks, busRouteStopHook)
	case boil.AfterUpsertHook:
		busRouteStopAfterUpsertHooks = append(busRouteStopAfterUpsertHooks, busRouteStopHook)
	}
}
...
func FindBusRouteStop(ctx context.Context, exec boil.ContextExecutor, routeID int, stopID int, selectCols ...string) (*BusRouteStop, error) {
	...
	if err = busRouteStopObj.doAfterSelectHooks(ctx, exec); err != nil {
		return busRouteStopObj, err
	}
...
func (o BusRouteStopSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if len(busRouteStopBeforeDeleteHooks) != 0 {
		for _, obj := range o {
	...
	if len(busRouteStopAfterDeleteHooks) != 0 {
		for _, obj := range o {
